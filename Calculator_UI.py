...
class Calculator_UI():
    ...
    def desingPage_Hexa(me):
        ...
        me.makeField(page, QtWidgets.QLabel(page), 15, 15, 130, 24).setText('原 Hexa')
        me.makeField(page, QtWidgets.QLineEdit(page),11, 38, 138, 368).setEnabled(False)
        me.hexaSetting_origin_STR_UNIQUE       = me.makeField(page, QtWidgets.QLineEdit(page), 15, 15 + 26 *  1, 130, 24, 'STR' , 55, '')        
        me.hexaSetting_origin_DEX_UNIQUE       = me.makeField(page, QtWidgets.QLineEdit(page), 15, 15 + 26 *  2, 130, 24, 'DEX' , 55, '')
        me.hexaSetting_origin_INT_UNIQUE       = me.makeField(page, QtWidgets.QLineEdit(page), 15, 15 + 26 *  3, 130, 24, 'INT' , 55, '')
        me.hexaSetting_origin_LUK_UNIQUE       = me.makeField(page, QtWidgets.QLineEdit(page), 15, 15 + 26 *  4, 130, 24, 'LUK' , 55, '')        
        ...
        me.hexaSetting_origin_STR_UNIQUEIKE_P  = me.makeField(page, QtWidgets.QLineEdit(page), 15, 15 + 26 *  7, 130, 24, '爆傷%', 55, '％')
        ...
        me.makeField(page, QtWidgets.QLabel(page),192, 15, 130, 24).setText('變更 Hexa 1')
        me.makeField(page, QtWidgets.QLineEdit(page),188, 38, 138, 368).setEnabled(False)
        me.hexaSetting_Set1_STR_UNIQUE       = me.makeField(page, QtWidgets.QLineEdit(page), 192, 15 + 26 *  1, 130, 24, 'STR' , 55, '')        
        me.hexaSetting_Set1_DEX_UNIQUE       = me.makeField(page, QtWidgets.QLineEdit(page), 192, 15 + 26 *  2, 130, 24, 'DEX' , 55, '')        
        me.hexaSetting_Set1_INT_UNIQUE       = me.makeField(page, QtWidgets.QLineEdit(page), 192, 15 + 26 *  3, 130, 24, 'INT' , 55, '')        
        me.hexaSetting_Set1_LUK_UNIQUE       = me.makeField(page, QtWidgets.QLineEdit(page), 192, 15 + 26 *  4, 130, 24, 'LUK' , 55, '')                
        ...
        me.hexaSetting_Set1_STR_UNIQUEIKE_P  = me.makeField(page, QtWidgets.QLineEdit(page), 192, 15 + 26 *  7, 130, 24, '爆傷%', 55, '％')
        ...
        me.makeField(page, QtWidgets.QLabel(page),370, 15, 130, 24).setText('變更 Hexa 2')
        me.makeField(page, QtWidgets.QLineEdit(page),366, 38, 138, 368).setEnabled(False)
        me.hexaSetting_Set2_STR_UNIQUE       = me.makeField(page, QtWidgets.QLineEdit(page), 370, 15 + 26 *  1, 130, 24, 'STR' , 55, '')        
        me.hexaSetting_Set2_DEX_UNIQUE       = me.makeField(page, QtWidgets.QLineEdit(page), 370, 15 + 26 *  2, 130, 24, 'DEX' , 55, '')        
        me.hexaSetting_Set2_INT_UNIQUE       = me.makeField(page, QtWidgets.QLineEdit(page), 370, 15 + 26 *  3, 130, 24, 'INT' , 55, '')        
        me.hexaSetting_Set2_LUK_UNIQUE       = me.makeField(page, QtWidgets.QLineEdit(page), 370, 15 + 26 *  4, 130, 24, 'LUK' , 55, '')                
        ...
        me.hexaSetting_Set2_STR_UNIQUEIKE_P  = me.makeField(page, QtWidgets.QLineEdit(page), 370, 15 + 26 *  7, 130, 24, '爆傷%', 55, '％')
